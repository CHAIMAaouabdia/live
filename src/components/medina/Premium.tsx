...
export const Premium = () => (
  <section className="py-24 md:py-32 bg-gradient-warm relative overflow-hidden">
    <div className="absolute inset-0 opacity-10" style={{
      backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0L40 20L60 30L40 40L30 60L20 40L0 30L20 20Z' fill='none' stroke='%23f5e6c8' stroke-width='0.5'/%3E%3C/svg%3E\")"
    }} />
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {tiers.map((t) => (
          ...
          >
            ...
            <Button variant={t.featured ? "cirta" : "cirtaOutline"} size="lg" className="w-full">
              Choisir {t.name}
            </Button>
          </div>
        ))}
